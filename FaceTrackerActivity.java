...
public class FaceTrackerActivity extends AppCompatActivity {
    ...
    // Method to calculate the quality (based on duration)
    private int calculateQuality(long duration) {
        if (duration >= 8 * 60 * 60 * 1000) { // Assuming 8 hours is good sleep
            return 10; // High quality
        } else if (duration >= 6 * 60 * 60 * 1000) { // Assuming 6 hours is acceptable
            return 7; // Medium quality
        } else {
            return 5; // Low quality
        }
    }
...
//        });
    ...
    public void onBackPressed() {
        long endTime = System.currentTimeMillis(); // Set the end time when the back button is pressed

        // Adjust the calculation of startTime, duration, and quality based on your application's logic
        long startTime = endTime - (duration * 1000); // Assuming duration is in seconds, convert it to milliseconds
        long duration = calculateDuration(); // Calculate the duration based on your logic
        int quality = calculateQuality(); // Calculate the quality based on your logic
        ...
        // Create an instance of SleepData
        ...
        long newRowId = databaseHelper.insertSleepRecord(sleepData);

        // Check if the insertion was successful
        if (newRowId != -1) {
            // Data inserted successfully
            Toast.makeText(this, "Sleep data inserted successfully", Toast.LENGTH_SHORT).show();
        } else {
            // Error occurred while inserting data
            Toast.makeText(this, "Failed to insert sleep data", Toast.LENGTH_SHORT).show();
        }
    }

    // Method to calculate the duration (you should replace this with your logic)
    private long calculateDuration() {
        // Add your logic to calculate the duration here
        return 0; // Placeholder value, replace with actual calculation
    }

    // Method to calculate the quality (you should replace this with your logic)
    private int calculateQuality() {
        // Add your logic to calculate the quality here
        return 0; // Placeholder value, replace with actual calculation
    }
